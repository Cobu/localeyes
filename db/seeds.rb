...
FactoryGirl.create(:daily_event, :business=>cafe, :start_time => Time.utc(2011,now.month,5,10,15), :title=>"whole day fiesta")
...
FactoryGirl.create(:daily_event, :business=>resto, :start_time => Time.utc(2011,now.month,1,19,45), :title=>"happy hour", :event_type=> Event::SPECIAL)
